...
export const componentSourceFiles: readonly string[] = [
  ...
  "src/components/IAgentScreen.vue",
  ...
  "src/components/IArtifactWorkspace.vue",
  ...
  "src/components/IChartAdjacency.vue",
  ...
  "src/components/IChartRealtime.vue",
  "src/components/IChartRetention.vue",
  "src/components/IChartSankey.vue",
  "src/components/IChartScatter.vue",
  "src/components/IChartSunburst.vue",
