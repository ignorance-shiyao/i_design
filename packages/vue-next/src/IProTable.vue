...
const emit = defineEmits<{
  ...
  'update:columnState': [state: ColumnState]
}>()
  ...
  <section class="i-pro-table">
    <div class="i-pro-table__bar">
      ...
      <div class="i-pro-table__tools">
        <ISegmented
          :model-value="columnState.density"
          :options="densities"
          @update:model-value="(v: string | number) => setColumnState(setDensity(columnState, v as TableDensity))"
        />
        <IButton size="sm" :aria-expanded="panel" @click="panel = !panel">
    ...
    <div v-if="panel" class="i-pro-table__panel">
      <div v-for="column in resolved" :key="column.key" class="i-pro-table__panel-row">
        <ICheckbox
          ...
          @update:model-value="() => onToggleColumn(column.key)"
        >
          {{ column.title }}
    ...
    <div class="i-pro-table__foot">
      ...
      <label class="i-pro-table__size">
        ...
        <select
          ...
          @change="(e) => onPageSize(Number((e.target as HTMLSelectElement).value))"
        >
