<!--
  由 packages/vue/scripts/convert.mjs 从 src/components/IFormPage.vue 转换而来。
...
const emit = defineEmits<{ (e: 'input', values: Record<string, unknown>): void; (e: 'submit', values: Record<string, unknown>): void; (e: 'cancel'): void; (e: 'reset', values: Record<string, unknown>): void }>()
...
watch(() => props.value, () => { asking.value = false })
