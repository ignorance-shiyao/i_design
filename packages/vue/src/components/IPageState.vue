<!--
  由 packages/vue/scripts/convert.mjs 从 src/components/IPageState.vue 转换而来。
...
<template>
  <div class="i-page-state">
    ...
    <div v-if="state.keepsContent" class="i-page-state__content" :aria-busy="String(state.kind === 'loading')">
      <slot />
    </div>
  </div>
</template>
