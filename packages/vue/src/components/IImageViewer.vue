<!--
  由 packages/vue/scripts/convert.mjs 的人工清单维护，与 src/components/IImageViewer.vue 对应。
  差异仅在 Vue 2 的语法约束（Teleport / defineModel），行为保持一致。
-->
