<!--
  由 packages/vue/scripts/convert.mjs 从 src/components/IThread.vue 转换而来。
...
const emit = defineEmits<{ (e: 'reply', comment: ThreadComment): void; (e: 'retry', comment: ThreadComment): void; (e: 'discard', comment: ThreadComment): void; (e: 'jump', id: string): void; (e: 'read', lastReadAt: number): void }>()
