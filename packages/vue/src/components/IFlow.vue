...
const emit = defineEmits<{ (e: 'update:selection', a0: string[]): void; (e: 'move', a0: { id: string; x: number; y: number; width?: number; height?: number }[]): void; (e: 'update:groups', a0: FlowGroup[]): void }>()
