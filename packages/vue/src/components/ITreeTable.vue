...
const emit = defineEmits<{ (e: 'update:expanded', a0: string[]): void; (e: 'update:selected', a0: string[]): void; (e: 'update:sortKey', a0: string | null): void; (e: 'update:sortOrder', a0: SortOrder): void }>()
