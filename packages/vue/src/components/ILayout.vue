<!--
  由 packages/vue/scripts/convert.mjs 从 src/components/ILayout.vue 转换而来。
...
<template>
  ...
  >
    <header v-if="$scopedSlots.header" class="i-layout__header"><slot name="header" /></header>
    ...
    <footer v-if="$scopedSlots.footer" class="i-layout__footer"><slot name="footer" /></footer>
  </div>
</template>
