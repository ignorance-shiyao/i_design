// 由 packages/flutter/scripts/build-icons.mjs 从 @i-design/common 生成，请勿手改。
//
...
const Map<String, String> kIDesignIconPaths = <String, String>{
  ...
  'filter':
      'M3 5h18l-7 8v6l-4 2v-8z',
  'edit':
      'M4 20h4L19 9a2.8 2.8 0 0 0-4-4L4 16z',
  'copy':
      'M9 9h10v10H9zM5 15V5h10',
  'trash':
      'M4 7h16M10 4h4M6 7l1 13h10l1-13M10 11v6M14 11v6',
  'download':
  ...
  'external-link':
      'M14 5h5v5M19 5l-8 8M18 14v5H5V6h5',
  'check-circle':
      'M12 21a9 9 0 1 1 0-18 9 9 0 0 1 0 18zM8.5 12.5l2.5 2.5 4.5-5',
  'info-circle':
      'M12 21a9 9 0 1 1 0-18 9 9 0 0 1 0 18zM12 11v5M12 8h.01',
  'warning-triangle':
      'M12 4 2.5 20h19zM12 10v4M12 17h.01',
  'error-circle':
      'M12 21a9 9 0 1 1 0-18 9 9 0 0 1 0 18zM9.5 9.5l5 5M14.5 9.5l-5 5',
  'help-circle':
      'M12 21a9 9 0 1 1 0-18 9 9 0 0 1 0 18zM9.5 9.5a2.5 2.5 0 1 1 3 2.4V14M12 17h.01',
  'user':
      'M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM4 20a8 8 0 0 1 16 0',
  'calendar':
      'M4 6h16v14H4zM4 10h16M9 3v4M15 3v4',
  'clock':
      'M12 21a9 9 0 1 1 0-18 9 9 0 0 1 0 18zM12 7.5V12l3 2',
  'folder':
      'M4 6h6l2 2h8v11H4z',
  'file':
      'M6 3h8l4 4v14H6zM14 3v4h4',
  'file-text':
      'M6 3h8l4 4v14H6zM14 3v4h4M9 13h6M9 17h4',
  'file-image':
      'M6 3h8l4 4v14H6zM14 3v4h4M9 17l2.5-3 2 2.2 1.5-1.7L18 17z',
  'file-sheet':
      'M6 3h8l4 4v14H6zM14 3v4h4M9 12h8M9 16h8M13 12v8',
  'file-code':
      'M6 3h8l4 4v14H6zM14 3v4h4M10.5 12.5 8.5 15l2 2.5M14 12.5l2 2.5-2 2.5',
  'file-zip':
      'M6 3h8l4 4v14H6zM14 3v4h4M10 5h2M10 8h2M10 11h2M10 14h2',
  'file-media':
      'M6 3h8l4 4v14H6zM14 3v4h4M10.5 12.5v5l4.5-2.5z',
  'layers':
      'M12 3 3 8l9 5 9-5zM3 13l9 5 9-5',
  'grid':
  ...
  'code':
      'M9 7l-5 5 5 5M15 7l5 5-5 5',
  'marquee':
      'M4 8V6a2 2 0 0 1 2-2h2M16 4h2a2 2 0 0 1 2 2v2M20 16v2a2 2 0 0 1-2 2h-2M8 20H6a2 2 0 0 1-2-2v-2M11 4h2M11 20h2M4 11v2M20 11v2',
  'minimap':
      'M4 5h16v14H4zM12 11h6v6h-6z',
  'sparkle':
      'M12 3l1.8 5.2L19 10l-5.2 1.8L12 17l-1.8-5.2L5 10l5.2-1.8z',
  'pin':
      'M9 4h6l-1 5 3 3v2h-4.5V21L12 22l-.5-1v-6.9H7v-2l3-3z',
  'text-size':
